...
const Airports = props => {
    ...
    useEffect(() => {
        ...
        fetch('https://api-dot-naviaero.uc.r.appspot.com/api/airports')
            ...
            .then(data => { setAirports(data.airports); setTemp(data.airports) })
    ...
    function fetchSearchResults(query) {
        ...
        axios.get(searchUrl)
            .then((info) => {
                ...
                setAirports(info.data.airports);;
                        ...
                        <Grid container spacing={1} alignItems="flex-end">
                            ...
                            <Grid item>
                                ...
                                <TextField
                                    ...
                                    label="Enter a airport's name or country..."
                            ...
                            <Grid item>
                                <CloseIcon className="icon" onClick={() => { setAirports(temp) 
