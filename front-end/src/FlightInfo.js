...
const FlightInfo = () => {
    ...
    if (info.airports != null && info.airports.length != 0) {
        airportInfo = info.airports.map((airport) =>
            <InfiniteScroll dataLength={1000}
                            ...
                            height={400}>
                <div>
                    <p onClick={refreshPage} to={"/airports/" + airport.airport_id}
                       onClick={event => window.location.href = "/airports/" + airport.airport_id}
                    >
                        {airport != null && airport.airport_id != null && airport.length != 0 ? (
    ...
    let lineInfo;
    if (info.airline != null && info.airline.length != 0) {
        lineInfo =
            <InfiniteScroll dataLength={1000}
                            style={{
                                display: 'inline-flex',
                            ...
                            height={400}>
                <div>
                    <p onClick={refreshPage} to={"/airlines/" + info.airline.airline_id}
                       onClick={event => window.location.href = "/airlines/" + info.airline.airline_id}
                    >
                        {info.airline != null && info.airline.airline_id != null && info.airline.length != 0 ? (
                            "Airline Name: " + info.airline.airline_name + "\n" +
                            "Iata Code: " + info.airline.iata_code + "\n"
                        ) : "No Information found"}
                    </p>
                </div>
            </InfiniteScroll>
